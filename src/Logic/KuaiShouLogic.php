...
class KuaiShouLogic extends Base
{
    ...
    {
        return $this->contents['shareTokenDialog']['feed']['cover_thumbnail_urls'][0]['url'] ?? '';
    }

    public function getVideoDesc()
    {
        return $this->contents['shareTokenDialog']['feed']['caption'] ?? '';
    }

    public function getUsername()
    {
        return $this->contents['shareTokenDialog']['feed']['user_name'] ?? '';
